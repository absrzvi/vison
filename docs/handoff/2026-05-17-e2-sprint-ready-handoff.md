...
| ~~OQ9~~ | ~~Health poll interval for rtsp-ingest and event-store~~ | ~~"Updated Xs ago" freshness~~ | ✅ Resolved: **10s** (`HEALTH_POLL_INTERVAL_SEC = 10`) |
...
2. ~~Resolve OQ9~~ — resolved (10s poll interval)
